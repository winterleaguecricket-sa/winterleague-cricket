      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '2rem' }}>
                ...
                >
                  ...
                  <div style={{
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <path d="M4 22h16" />
                      <path d="M10 22V8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v1" />
                      <path d="M14 22V8a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1" />
                      <path d="M8 6h8" />
                      <path d="M8 14h8" />
                    </svg>
                  </div>
        ...
        {activeTab === 'competition' && (() => {
          ...
          if (!autoSelected) {
            return (
              <div>
                <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#f9fafb', marginBottom: '0.5rem' }}>Your Competition</h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.25rem' }}>
                  {players.map((p, idx) => (
                    ...
                    >
                      <ShineEffect />
                      <div style={{ fontSize: '2rem', fontWeight: 900, color: '#fbbf24', marginBottom: '0.25rem' }}>{p.ageGroup}</div>
                      <div style={{ fontSize: '1.05rem', fontWeight: 700, color: '#f9fafb' }}>{p.playerName}</div>
                      <div style={{ fontSize: '0.85rem', color: '#9ca3af', fontWeight: 600, marginTop: '0.25rem' }}>{p.teamName}</div>
                      <span style={{
                        position: 'absolute',
                        top: '1rem',
                        right: '1rem',
                        ...
                        {p.competition?.totalTeams || 0} teams
                      </span>
                    </div>
                  ))}
                </div>
                ...
                {teams.map((t, idx) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseLeave={removeDashboardCardHover}
                      style={{
                        background: isMyTeam ? 'linear-gradient(135deg, #111827 0%, rgba(251,191,36,0.08) 100%)' : '#111827',
                        padding: '1.25rem',
                        borderRadius: '12px',
                        border: isMyTeam ? '1px solid rgba(251,191,36,0.4)' : '1px solid rgba(255,255,255,0.08)',
                        boxShadow: isMyTeam ? '0 4px 20px rgba(251,191,36,0.15)' : '0 1px 3px rgba(0,0,0,0.4)',
                        transition: 'all 0.3s',
                        position: 'relative',
                        overflow: 'hidden',
                        textAlign: 'center',
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        {t.teamLogo ? (
                          <img src={t.teamLogo} alt={t.teamName} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        ) : (
                          <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6b7280', fontSize: '1.5rem', fontWeight: 900 }}>
                            {(t.teamName || '?')[0]}
                          </div>
                        )}
                      </div>
                      <div style={{ fontSize: '0.95rem', fontWeight: 800, color: '#f9fafb', marginBottom: '0.25rem', lineHeight: 1.3 }}>
                        {t.teamName}
                      </div>
                      ...
                      {t.cupWins > 0 && (
                        <div style={{ marginTop: '0.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.3rem', background: 'rgba(251,191,36,0.15)', padding: '0.2rem 0.6rem', borderRadius: '999px' }}>
                          <span style={{ fontSize: '0.8rem' }}>🏆</span>
                          <span style={{ fontSize: '0.75rem', fontWeight: 800, color: '#fbbf24' }}>{t.cupWins}</span>
                        </div>
                      )}
                      {t.shirtDesign && (
                        <div style={{ position: 'absolute', bottom: '0.5rem', right: '0.5rem', width: '28px', height: '28px', borderRadius: '50%', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.55rem', color: '#6b7280', fontWeight: 700 }}>
                          {t.shirtDesign.replace('Kit ', 'K')}
                        </div>
                      )}
                    </div>
                  );
