...
export default function AdminSupporterProducts() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Supporter Apparel - Admin Panel</title>
      </Head>

      <header className={styles.header}>
        <div className={styles.headerContent}>
          <h1 className={styles.logo}>👕 Supporter Apparel</h1>
      ...
      <main className={styles.main}>
        <div className={styles.toolbar}>
          <div>
            <h2>Manage Supporter Apparel Products</h2>
            <p style={{ margin: '0.5rem 0 0 0', color: '#6b7280', fontSize: '0.95rem' }}>
              Configure supporter merchandise available during player registration
            </p>
          </div>
          <button 
                ...
                <div className={styles.formRow} style={{ paddingTop: '1.5rem' }}>
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      required
                      placeholder="e.g., Supporter Jersey"
        ...
        <div className={styles.productsTable}>
          {products.length > 0 ? (
              ...
              <table style={{ fontSize: '0.9rem' }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ width: '35%', padding: '0.65rem', fontSize: '0.85rem' }}>Description</th>
                    <th style={{ width: '15%', padding: '0.65rem', fontSize: '0.85rem' }}>Price</th>
                    <th style={{ width: '10%', padding: '0.65rem', fontSize: '0.85rem' }}>Status</th>
            ...
            <div style={{
              ...
              <h3 style={{ margin: '0 0 0.5rem 0', fontSize: '1.5rem' }}>No Supporter Products Yet</h3>
              <p style={{ color: '#6b7280', margin: 0 }}>Click "Add Product" to create your first supporter apparel item</p>
            </div>
          )}
        </div>
      </main>
