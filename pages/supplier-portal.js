...
export default function SupplierPortal() {
  ...
  const applyHover = (e) => {
    ...
    e.currentTarget.style.borderColor = 'rgba(248,113,113,0.48)';
    e.currentTarget.style.boxShadow = '0 24px 44px rgba(0,0,0,0.32), 0 0 0 1px rgba(248,113,113,0.12)';
    e.currentTarget.style.background = 'linear-gradient(160deg, rgba(15,23,42,0.98) 0%, rgba(2,6,23,0.98) 58%, rgba(127,29,29,0.42) 100%)';
  };
  const removeHover = (e) => {
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)';
    e.currentTarget.style.boxShadow = '0 12px 24px rgba(0,0,0,0.18)';
    e.currentTarget.style.background = 'linear-gradient(180deg, rgba(17,24,39,0.98) 0%, rgba(15,23,42,0.98) 100%)';
  };
  ...
  if (!supplier) {
    return (
      <>
        <Head>
          <title>Supplier Portal - Winter League Cricket</title>
          <link rel="preconnect" href="https://fonts.googleapis.com" />
          <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
          <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
        </Head>
        <div className="supplier-portal-theme" style={{
          minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center',
          background: 'radial-gradient(circle at top left, rgba(220,0,0,0.2), transparent 26%), radial-gradient(circle at bottom right, rgba(96,165,250,0.16), transparent 20%), linear-gradient(180deg, #020617 0%, #07111f 50%, #030712 100%)', padding: '2rem', fontFamily: '"Manrope", "Segoe UI", sans-serif'
        }}>
          <div style={{
            background: 'linear-gradient(180deg, rgba(15,23,42,0.92) 0%, rgba(2,6,23,0.96) 100%)', padding: '2.5rem', borderRadius: '28px',
            boxShadow: '0 28px 60px rgba(0,0,0,0.4)', width: '100%', maxWidth: '460px', border: '1px solid rgba(148,163,184,0.18)', backdropFilter: 'blur(18px)'
          }}>
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              <h1 style={{
                fontSize: '2.15rem', fontWeight: '800', letterSpacing: '-0.05em',
                background: 'linear-gradient(135deg, #f8fafc 0%, #fda4af 60%, #7dd3fc 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '0.5rem'
              }}>Supplier Portal</h1>
              <p style={{ color: '#94a3b8', fontSize: '0.95rem' }}>Premium operations hub for orders, products, returns, and payouts.</p>
            </div>
            <form onSubmit={handleLogin}>
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'block', fontWeight: '700', marginBottom: '0.5rem', fontSize: '0.78rem', color: '#94a3b8', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Email</label>
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" required autoComplete="email"
                  style={{ width: '100%', padding: '0.9rem 1rem', border: '1px solid rgba(148,163,184,0.18)', borderRadius: '14px', fontSize: '0.95rem', color: '#f8fafc', background: 'rgba(15,23,42,0.74)', outline: 'none', transition: 'border-color 0.2s, box-shadow 0.2s', boxSizing: 'border-box' }}
                  onFocus={(e) => { e.target.style.borderColor = 'rgba(248,113,113,0.55)'; e.target.style.boxShadow = '0 0 0 3px rgba(220,38,38,0.16)'; }} onBlur={(e) => { e.target.style.borderColor = 'rgba(148,163,184,0.18)'; e.target.style.boxShadow = 'none'; }} />
              </div>
              <div style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'block', fontWeight: '700', marginBottom: '0.5rem', fontSize: '0.78rem', color: '#94a3b8', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Password</label>
              ...
              {error && (
                <div style={{ padding: '0.85rem', background: 'rgba(239,68,68,0.12)', border: '1px solid rgba(248,113,113,0.28)', borderRadius: '14px', color: '#fecaca', fontSize: '0.85rem', marginBottom: '1rem', textAlign: 'center', fontWeight: 700 }}>
                  {error}
                </div>
              )}
              <button type="submit" style={{
                width: '100%', padding: '0.95rem',
                background: 'linear-gradient(135deg, #7f1d1d 0%, #dc2626 52%, #fb7185 100%)',
                color: 'white', border: 'none', borderRadius: '8px',
                fontSize: '0.95rem', fontWeight: '800', cursor: 'pointer', transition: 'transform 0.2s, box-shadow 0.2s', boxShadow: '0 18px 30px rgba(127,29,29,0.3)'
              }}
                onMouseEnter={(e) => { e.target.style.transform = 'translateY(-2px)'; e.target.style.boxShadow = '0 22px 34px rgba(127,29,29,0.38)'; }}
                onMouseLeave={(e) => { e.target.style.transform = 'translateY(0)'; e.target.style.boxShadow = '0 18px 30px rgba(127,29,29,0.3)'; }}
              >Enter Workspace</button>
            </form>
            <div style={{ marginTop: '1.5rem', padding: '1rem', background: 'rgba(255,255,255,0.04)', borderRadius: '16px', fontSize: '0.8rem', color: '#94a3b8', border: '1px solid rgba(148,163,184,0.14)' }}>
              <strong style={{ display: 'block', marginBottom: '0.5rem', color: '#f8fafc', fontSize: '0.78rem', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Become a supplier</strong>
              <p style={{ margin: 0 }}>
                <a href="/become-a-supplier" style={{ color: '#fda4af', textDecoration: 'none', fontWeight: 700 }}>Apply here</a> to register as a cricket equipment supplier on Winter League Cricket.
              </p>
            </div>
          </div>
          <style jsx global>{`
            ...
            .supplier-portal-theme ::-webkit-scrollbar {
              width: 10px;
              height: 10px;
            }
            .supplier-portal-theme ::-webkit-scrollbar-thumb {
  ...
  if (isAdminMode) {
    tabs.push({ key: 'applications', label: 'Applications' });
  }
  ...
  return (
    <>
      ...
      <div className="supplier-portal-theme" style={{ minHeight: '100vh', background: 'radial-gradient(circle at top left, rgba(220,0,0,0.18), transparent 22%), radial-gradient(circle at top right, rgba(96,165,250,0.12), transparent 24%), linear-gradient(180deg, #030712 0%, #08111f 45%, #020617 100%)', fontFamily: '"Manrope", "Segoe UI", sans-serif' }}>
        {/* Header */}
        <div style={{
          background: 'linear-gradient(135deg, rgba(8,15,30,0.94) 0%, rgba(15,23,42,0.94) 52%, rgba(127,29,29,0.84) 100%)',
          borderBottom: '1px solid rgba(148,163,184,0.14)', padding: '1.05rem 1.5rem',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          position: 'sticky', top: 0, zIndex: 50, backdropFilter: 'blur(14px)', boxShadow: '0 18px 38px rgba(0,0,0,0.28)'
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div>
              <div style={{ color: '#fff', fontWeight: '800', fontSize: '1.1rem' }}>
                {supplier.companyName}
                {isAdminMode && <span style={{ marginLeft: '0.5rem', padding: '0.2rem 0.6rem', borderRadius: '999px', background: 'rgba(248,113,113,0.14)', color: '#fecaca', fontSize: '0.63rem', fontWeight: 800, verticalAlign: 'middle', letterSpacing: '0.08em', textTransform: 'uppercase', border: '1px solid rgba(248,113,113,0.2)' }}>Admin View</span>}
              </div>
              <div style={{ color: '#94a3b8', fontSize: '0.75rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Supplier Workspace</div>
            </div>
          </div>
          <button onClick={handleLogout}
            style={{
              padding: '0.65rem 1rem', background: 'rgba(255,255,255,0.05)', color: '#f8fafc',
              border: '1px solid rgba(148,163,184,0.16)', borderRadius: '14px', fontSize: '0.78rem',
              fontWeight: 800, cursor: 'pointer', transition: 'all 0.2s', letterSpacing: '0.04em', textTransform: 'uppercase'
            }}
            onMouseEnter={e => { e.target.style.background = 'rgba(248,113,113,0.16)'; e.target.style.borderColor = 'rgba(248,113,113,0.24)'; }}
            onMouseLeave={e => { e.target.style.background = 'rgba(255,255,255,0.05)'; e.target.style.borderColor = 'rgba(148,163,184,0.16)'; }}
          >
        ...
        {/* Tab Navigation */}
        <div style={{
          background: 'rgba(9,15,28,0.82)', borderBottom: '1px solid rgba(148,163,184,0.08)',
          padding: '0.75rem 1.5rem 0.6rem', display: 'flex', overflowX: 'auto', gap: '0.5rem', backdropFilter: 'blur(12px)'
        }}>
          {tabs.map(tab => (
            <button key={tab.key} onClick={() => setActiveTab(tab.key)}
              style={{
                padding: '0.8rem 1rem', background: activeTab === tab.key ? 'linear-gradient(135deg, rgba(127,29,29,0.84) 0%, rgba(15,23,42,0.98) 100%)' : 'transparent', border: '1px solid transparent',
                color: activeTab === tab.key ? '#fff' : '#94a3b8',
                fontSize: '0.82rem', fontWeight: activeTab === tab.key ? 800 : 600,
                cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.2s',
                display: 'flex', alignItems: 'center', gap: '0.4rem', borderRadius: '14px', boxShadow: activeTab === tab.key ? '0 14px 24px rgba(127,29,29,0.18)' : 'none'
              }}
            >
              {tab.label}
            </button>
        ...
        {/* Content */}
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '1.75rem 1.5rem 2.5rem' }}>
          {renderTabContent()}
        </div>
        <style jsx global>{`
          .supplier-portal-theme {
          ...
          .supplier-portal-theme button:hover {
            transform: translateY(-1px);
          }
          .supplier-portal-theme input:focus,
          .supplier-portal-theme select:focus,
          .supplier-portal-theme textarea:focus {
